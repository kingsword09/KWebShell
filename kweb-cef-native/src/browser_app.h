...
public:
  ...
  void OnMv3DevToolsOpened();
  void OnMv3DevToolsFrontendLoaded(const std::string &url,
...
private:
  ...
  void MaybeBeginMv3DevToolsSelfTest();
  ...
  bool mv3_devtools_frontend_loaded_ = false;
